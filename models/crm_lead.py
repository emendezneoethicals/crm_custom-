...
class CrmLead(models.Model):
    ...
    clinic_department = fields.Char(string="Departamento", related="partner_id.clinic_department", store=True, readonly=False)
    clinic_municipality = fields.Char(string="Municipio", related="partner_id.clinic_municipality", store=True, readonly=False)
